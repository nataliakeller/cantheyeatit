import { ref, computed, unref, provide, getCurrentInstance as getCurrentInstance$1, shallowRef, reactive, watchEffect, toRef, warn, inject as inject$1, toValue, Fragment, capitalize, watch, onScopeDispose, camelize, defineComponent as defineComponent$1, toRaw, isVNode, Comment, hasInjectionContext, createVNode, mergeProps, createElementVNode, effectScope, normalizeClass, defineAsyncComponent, h, shallowReactive, Suspense, createApp, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, isReadonly, isRef, isShallow, isReactive, getCurrentScope, withCtx, toRefs, nextTick, useSSRContext } from 'vue';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BnCcph2x.mjs')
  },
  {
    name: "food-new",
    path: "/food/new",
    component: () => import('./new-CGZMLx35.mjs')
  },
  {
    name: "food-id",
    path: "/food/:id()",
    component: () => import('./_id_-DaIIn7cI.mjs')
  },
  {
    name: "food",
    path: "/food",
    component: () => import('./index-Bh7Bu5XO.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-kGcbY3Xn.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DSv5VEKP.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DeG3TJ9b.mjs'));
...
export { pick as $, provideDefaults as A, includes as B, getCurrentInstance as C, templateRef as D, EventProp as E, getCurrentInstanceName as F, destructComputed as G, isCssColor as H, IconValue as I, isParsableColor as J, parseColor as K, getForeground as L, consoleWarn as M, findChildrenWithProvide as N, convertToUnit as O, useTheme as P, useIcon as Q, flattenFragments as R, clamp as S, hasEvent as T, isObject as U, keyCodes as V, onlyDefinedProps as W, filterInputAttrs as X, callEvent as Y, useToggleScope as Z, _export_sfc as _, useNuxtApp as a, consoleError as a0, defineComponent as a1, deprecate as a2, isPrimitive as a3, focusChild as a4, CircularBuffer as a5, defer as a6, isClickInsideElement as a7, getNextElement as a8, debounce as a9, camelizeProps as aa, IN_BROWSER as ab, breakpoints as ac, useRuntimeConfig as b, nuxtLinkDefaults as c, genericComponent as d, entry$1 as default, useLocale as e, useProxiedModel as f, getPropertyFromItem as g, noop as h, ensureValidVNode as i, checkPrintable as j, deepEqual as k, provideTheme as l, matchesSelector as m, navigateTo as n, omit as o, propsFactory as p, makeThemeProps as q, resolveRouteObject as r, makeDisplayProps as s, tryUseNuxtApp as t, useRouter as u, useRtl as v, wrapInArray as w, useDisplay as x, useGoTo as y, focusableChildren as z };
