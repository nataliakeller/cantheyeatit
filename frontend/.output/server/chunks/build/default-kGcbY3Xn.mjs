import { withCtx, createVNode, createTextVNode, renderSlot, shallowRef, computed, inject, ref, reactive, toRef, provide, createElementVNode, normalizeStyle, normalizeClass, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderSlot } from 'vue/server-renderer';
import { useRoute, useRouter } from 'vue-router';
import { d as VBtn, b as VIcon, a as useRender, i as useBackgroundColor, j as useBorder, n as useElevation, o as useRounded, l as useDimension, h as makeComponentProps, D as useResizeObserver, w as makeTagProps, x as makeRoundedProps, y as makeElevationProps, B as makeBorderProps, z as makeDimensionProps, U as VImg, c as VDefaultsProvider, G as VExpandTransition } from './index-CV-ig810.mjs';
import { d as genericComponent, p as propsFactory, l as provideTheme, v as useRtl, A as provideDefaults, q as makeThemeProps, O as convertToUnit, C as getCurrentInstance, N as findChildrenWithProvide } from './server.mjs';
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VBtn, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VIcon, { icon: "mdi-home" }, null, _parent4, _scopeId3));
                        _push4(` Home `);
                      } else {
                        return [
                          createVNode(VIcon, { icon: "mdi-home" }),
                  ...
                  _push3(ssrRenderComponent(VBtn, {
                    stacked: "",
                    onClick: ($event) => navigateTo("/food")
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VIcon, { icon: "mdi-list-box" }, null, _parent4, _scopeId3));
                        _push4(` Lista `);
                      } else {
                        return [
                          createVNode(VIcon, { icon: "mdi-list-box" }),
                          createTextVNode(" Lista ")
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent(VBtn, {
                    stacked: "",
                    onClick: ($event) => navigateTo("/food/new")
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VIcon, { icon: "mdi-plus-box" }, null, _parent4, _scopeId3));
                        _push4(` Nuovo `);
                      } else {
                        return [
                          createVNode(VIcon, { icon: "mdi-plus-box" }),
                          createTextVNode(" Nuovo ")
                        ];
                      }
                    }),
                    _: 1
...
//# sourceMappingURL=default-kGcbY3Xn.mjs.map
