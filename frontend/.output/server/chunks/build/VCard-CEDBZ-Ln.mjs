import { d as genericComponent, p as propsFactory, l as provideTheme, A as provideDefaults, e as useLocale, f as useProxiedModel, b as useRuntimeConfig, q as makeThemeProps, I as IconValue, E as EventProp, s as makeDisplayProps, v as useRtl, x as useDisplay, y as useGoTo, k as deepEqual, z as focusableChildren } from './server.mjs';
import { withDirectives, createVNode, mergeProps, createElementVNode, capitalize, h, camelize, normalizeStyle, normalizeClass, toRef, computed, vShow, Fragment, toDisplayString, shallowRef } from 'vue';
import { R as Ripple, j as useBorder, q as useVariant, k as useDensity, l as useDimension, n as useElevation, f as useLoader, P as useLocation, Q as usePosition, o as useRounded, p as useLink, a as useRender, r as genOverlays, U as VImg, c as VDefaultsProvider, L as LoaderSlot, h as makeComponentProps, W as useSize, X as useGroupItem, s as VExpandXTransition, b as VIcon, v as makeVariantProps, w as makeTagProps, C as makeRouterProps, x as makeRoundedProps, S as makePositionProps, T as makeLocationProps, E as makeLoaderProps, y as makeElevationProps, z as makeDimensionProps, A as makeDensityProps, B as makeBorderProps, Y as makeSizeProps, Z as makeGroupItemProps, _ as makeGroupProps, $ as useGroup, D as useResizeObserver, a0 as VFadeTransition } from './index-CV-ig810.mjs';
...
const useApi = () => {
  ...
  const fetchWithConfig = async (endpoint, options = {}) => {
    ...
    try {
      ...
      console.error("Error details:", {
        endpoint: config.public.apiBase + endpoint,
        options,
        error: error.message,
      ...
      if ((_a = error.message) == null ? void 0 : _a.includes("Failed to fetch")) {
        throw new Error("Unable to connect to server. Please check if the backend is running on " + config.public.apiBase);
      }
      throw error;
    }
  };
  const foods = {
    ...
    // ⬅️ Mesma rota, mas agora com $fetch
    getById: (id) => fetchWithConfig(`/foods/${id}`),
    create: (food) => fetchWithConfig("/foods", {
      method: "POST",
      body: food
      // ⬅️ $fetch já transforma para JSON, não precisa JSON.stringify
    }),
    update: (id, food) => fetchWithConfig(`/foods/${id}`, {
      method: "PUT",
      body: food
    }),
    delete: (id) => fetchWithConfig(`/foods/${id}`, {
      method: "DELETE",
      headers: {}
    })
  };
...
export { VCard as V, VCardTitle as a, VCardText as b, VCardActions as c, VChip as d, VAvatar as e, createSimpleFunctional as f, VCardSubtitle as g, useApi as u };
//# sourceMappingURL=VCard-CEDBZ-Ln.mjs.map
